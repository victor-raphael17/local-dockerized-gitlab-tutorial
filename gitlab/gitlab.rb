...
external_url 'https://gitlab.myprojectinfra.com'
...
gitlab_rails['smtp_address'] = "mail.myprojectinfra.com"
gitlab_rails['smtp_port'] = 587
gitlab_rails['smtp_user_name'] = "gitlab@myprojectinfra.com"
gitlab_rails['smtp_password'] = "gitlab"
gitlab_rails['smtp_domain'] = "myprojectinfra.com"
...
gitlab_rails['gitlab_email_from'] = 'gitlab@myprojectinfra.com'
gitlab_rails['gitlab_email_display_name'] = 'noreply'
gitlab_rails['gitlab_email_reply_to'] = 'gitlab@myprojectinfra.com'
...
gitlab_rails['trusted_proxies'] = ['192.168.0.0/22','172.20.0.0/22']
...
registry_external_url 'https://gitlab.myprojectinfra.com:5050'
